...
public class Sample {
	...
	public String toString() {
		return "Sample [sampleId=" + sampleId + ", sampleType=" + sampleType + ", recievingDate=" + recievingDate
				+ ", dateOfAllotment=" + dateOfAllotment + ", P_ID=" + P_ID + ", boxId=" + boxId + "]";
	}

	public Sample(int sampleId, String sampleType, Date recievingDate, Date dateOfAllotment, int p_ID, int boxId) {
		super();
		this.sampleId = sampleId;
		this.sampleType = sampleType;
		this.recievingDate = recievingDate;
