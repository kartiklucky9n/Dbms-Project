			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						<h1>
							Testing <span>&</span> Reporting
						</h1>
						<p>Path Labs is a semi-private organization for sample
							testing.</p>
						<div class="btn-group-vertical">
						<a href="patientForm" class="btn btn-primary page-scroll"
							role="button">Patient Form</a> 
