			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h2>
							YOUR USER ID : <span>${technicianUId}</span>
						</h2>
						<h3>After setting password you will be redirected to home page, please login thereafter</h3>
						<form class="well form-horizontal"
							action="/pathapp/setpass/${technicianUId }" method="post">
						...
						<a class="fadeIn fifth" href="/pathapp/goback"><button
												class="btn btn-primary btn-lg">Go Back</button></a>
